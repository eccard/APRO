package recode.appro.main.persistencia;
...
import recode.appro.faculdade.curso.modelo.Disciplina;
import recode.appro.evento.Evento;
import recode.appro.noticia.modelo.Noticia;
import recode.appro.faculdade.departamento.modelo.Professor;
...
//        cursor.moveToFirst();
    ...
    public String GetNomeUsuario(){
        Cursor cursor = dbQuery.rawQuery("SELECT nick FROM usuario ",null);
//        cursor.moveToFirst();
        cursor.moveToFirst();
